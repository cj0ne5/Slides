...
## 2025 : Today
![Cody on the first day of school 2025](images/cody_owl.jpg)
...
- No Retakes
- No Late Work
- Grades: Semester ONLY
    - Q1/Q3 APS Report Cards: Think of them like progress reports
...
## Pause - Read the DE Expectations Contract
Find it on the course homepage
...
## Generative AI - Rule in my class
- I think it's a great thing, and an important skill for you to learn
- We'll have a lot of fun with these tools this year
- Unless I say so, do not use it on any assignments
- Discussion: If you do use generative AI tools - will I know?

## Generative AI - Accountability
- You must understand all of the code you submit
- A big part of your grade will include:
    - evidence you produce as you're writing your code (git log - we'll talk more about this later in the week)
    - in class writing where you'll explain how your code works
...
## Today's Assignment:
- Access the course website: ict.gracehopper.center
